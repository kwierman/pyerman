...
#define __PYX_HAVE__pyerman__style__plot
#define __PYX_HAVE_API__pyerman__style__plot
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'pyerman.style.plot' */
#define __Pyx_MODULE_NAME "pyerman.style.plot"
int __pyx_module_is_main_pyerman__style__plot = 0;

/* Implementation of 'pyerman.style.plot' */
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_pyerman__style__plot) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pyerman.style.plot")) {
      if (unlikely(PyDict_SetItemString(modules, "pyerman.style.plot", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pyerman.style.plot", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pyerman.style.plot");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
