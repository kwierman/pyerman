...
class KJWImageTable:
    ...
    def _repr_html_(self):
        ...
        for i in self.names:
            if self.usepng:
                html.append('<td><img src="{}.png" width="100%" alt="Image \
                Rendering or Not Found"/></td>'.format(i))
            else:
                html.append('<td><img src="{}.svg" width="100%" \
                alt="Image Rendering or Not Found"/></td>'.format(i))
            j += 1
            if(j == n_col):
                html.append("</tr>")
                j = 0
