...
#define __PYX_HAVE__pyerman__analysis____init__
#define __PYX_HAVE_API__pyerman__analysis____init__
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'pyerman.analysis.__init__' */
#define __Pyx_MODULE_NAME "pyerman.analysis.__init__"
int __pyx_module_is_main_pyerman__analysis____init__ = 0;

/* Implementation of 'pyerman.analysis.__init__' */
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_pyerman__analysis____init__) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (unlikely(__Pyx_SetPackagePathFromImportLib("pyerman", __pyx_n_u_analysis) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pyerman.analysis")) {
      if (unlikely(PyDict_SetItemString(modules, "pyerman.analysis", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "pyerman/analysis/__init__.pyx":1
             # <<<<<<<<<<<<<<
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pyerman.analysis.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pyerman.analysis.__init__");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
